...
ActiveRecord::Schema.define(version: 20150824163822) do
  ...
  add_index "events", ["vip_id"], name: "index_events_on_vip_id"
  ...
  add_index "vips", ["event_id"], name: "index_vips_on_event_id"
